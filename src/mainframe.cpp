...
void CMainFrame::OnABOUTClick( wxCommandEvent& WXUNUSED(event) )
{
	...
	info.AddTranslator( wxString("\n") + wxT("Caretuse, bec: ") + _("Traditional Chinese") );
	...
	info.AddTranslator( wxString("\n") + wxT("Yaroslav D. Mudryy, Yuriy Karandyshev : ") + _("Russian") );
	info.AddTranslator( wxString("\n") + wxT("Yaroslav D. Mudryy : ") + _("Ukrainian") );
	info.AddTranslator( wxString("\n") + wxT("Hasan Osmanagi\u0107: ") + _("Croatian") );
	info.AddTranslator( wxString("\n") + wxT("Milos Popovic: ") + _("Serbian") );
	info.AddTranslator( wxString("\n") + wxT("Suguru SASAKI: ") + _("Japanese") );
	info.AddTranslator( wxString("\n") + wxT("Fulvio Senore: ") + _("Italian") );
	info.AddTranslator( wxString("\n") + wxT("Nick Sercaianu: ") + _("Romanian") );
	info.AddTranslator( wxString("\n") + wxT("Toni: ") + _("Bulgarian") );
	info.AddTranslator( wxString("\n") + wxT("Gideon van Melle: ") + _("Dutch") );
