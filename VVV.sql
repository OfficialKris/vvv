/******************************************************************************/
/*           Generated by IBExpert 2024.1.22.1 02/05/2024 16:51:15            */
/******************************************************************************/
...
begin
    ...
    begin
        ...
        where FILES.PATH_FILE_ID = :PATH_ID AND VIRTUAL_FILES.VIRTUAL_PATH_ID = :VIRTUAL_PATH_ID
        into :FILE_ID
        do
        begin
...
DESCRIBE FIELD PHYSICAL_PATH TABLE VOLUMES
'Path of the volume when it was cataloged or updated';

DESCRIBE FIELD CATALOG_DATE TABLE VOLUMES
'Date in which the volume was cataloged';

DESCRIBE FIELD LAST_UPDATE_DATE TABLE VOLUMES
'Date of the last update for this volume';
